...
<body>
    ...
    if (isset($_POST['product_update'])) {
        ...
        /* ==============================
           INSERT QUERY
        =============================== */
        $sql = "INSERT INTO product (pro_name, rating, review, category_id, sub_category_id, sub_subcategory_id, product_price, pro_discount, product_discount_price, fabric, blouse, about_item, product_image1, product_image2, product_image3, product_image4, color, featured_pro, special_off, trending_now, status
    ) VALUES ('$productname', '$ratingss', '$reviewss', '$category', '$subcategory', '$subsubcategory', '$productprice', '$discount1', '$productdiscountprice', '$fabric', '$blouse', '$about_item', '$new_file_name1', '$new_file_name2', '$new_file_name3', '$new_file_name4', '$colorString', '$featured', '$specialoffers', '$trendingnoww', '1'
    )";
