...
<head>
    ...
    <title>Krishika Collections | Colour</title>
                                        ...
                                        <tr>
                                            ...
                                            <td class=text-center>
                                                ...
                                                <button type="button" name="update3" class="btn btn-primary btn-sm m-2"
                                                    onclick="myfcn13(<?php echo $row['id']; ?>,'<?php echo $row['name']; ?>')"
                                                    data-toggle="modal" data-target="#updatedecategory" title="Edit"
                                                    aria-hidden="true">
                                                    <i class='fas fa-edit'></i>
                                                </button>
                                                <a onclick="confirmDelete(<?php echo $row['id']; ?>, tb='color', tbc='id', returnpage='color');"
                                                    title="Delete">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-white">Colour</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12">
                                <label for="exampleInputcname">Colour Name:</label>
...
if (isset($_POST['category_update'])) {
    ...
    // INSERT with image
    $sql = "INSERT INTO color (name, status) 
                        VALUES ('$name', '1')";
        ...
        <div class="modal-content">
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method='post' enctype="multipart/form-data">
                <div class="modal-body p-4">
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            <label for="text">Colour Name:</label>
...
if (isset($_POST['update4'])) {
    ...
    if ($image_name == NULL) {
        $sql1 = "UPDATE color SET name='$name' WHERE id='$id'";
