                                ...
                                <div class="mega-container">
                                    ...
                                    <div class="mega-column">
                                        ...
                                        <ul>
                                            ...
                                            <li class="sub-parent">
                                                <a href="shop.php" class="fw-bold text-warning">Silk Dress
                                                    Materials</a>
                                                <ul class="sub-sub-menu">
                                            ...
                                            <li class="sub-parent">
                                                <a href="shop.php" class="fw-bold text-warning">Ikat Dress
                                                    Materials</a>
                                                <ul class="sub-sub-menu">
                                                    <li><a href="product-details.php">Cotton Ikat</a></li>
                                                    <li><a href="product-details.php">Silk Ikat</a></li>
                                            ...
                                            <li class="sub-parent">
                                                ...
                                                <ul class="sub-sub-menu">
                                                    ...
                                                    <li><a href="product-details.php">Ethnic Wear Festive
                                                            Collection</a></li>
                                        ...
                                        <ul>
                                            ...
                                            <li class="sub-parent">
                                                ...
                                                <ul class="sub-sub-menu">
                                                    ...
                                                    <li><a href="product-details.php">Cotton Blouses Non-Padded</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="sub-parent">
                                                ...
                                                <ul class="sub-sub-menu">
                                                    <li><a href="product-details.php">Bridal Blouses Heavy Work</a>
                                                    </li>
                                        ...
                                        <ul>
                                            ...
                                            <li class="sub-parent">
                                                ...
                                                <ul class="sub-sub-menu">
                                                    ...
                                                    <li><a href="product-details.php">Metal Bangles Gold Plated</a>
                                                    </li>
                                                    ...
                                                    <li><a href="product-details.php">Beads Chains Single Layer</a>
                                                    </li>
